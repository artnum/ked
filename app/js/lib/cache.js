...
KEDCache.prototype.issetToken = function (token) {
    return new Promise((resolve, reject) => {
        this.open()
        .then(idb => {
...
KEDCache.prototype.setToken = function (token, mod) {
    return new Promise((resolve, reject) => {
        this.open()
        .then(idb => {
...
KEDCache.prototype.hasChunk = function (token) {
    return new Promise((resolve, reject) => {
        this.open()
        .then(idb => {
            const tr = idb.transaction(['UploadCache'], 'readonly')
...
KEDCache.prototype.getProgress = function () {
    return new Promise((resolve, reject) => {
        this.open()
        .then(idb => {
